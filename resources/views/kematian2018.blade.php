...
<body>
    ...
    <script>
        ...
        const kotabogorData = kotabogor.map(kematian_2018 =>({
            type: "Feature",
            properties: {
                name: kematian_2018.name,
                id: kematian_2018.id,
                alt_name: kematian_2018.alt_name,
                population: kematian_2018.population,
                luas_wilayah: kematian_2018.luas_wilayah,
                kematian: kematian_2018.kematian,
                latitude: kematian_2018.latitude,
                longitude: kematian_2018.longitude
            },
            geometry: {
                type: kematian_2018.type_polygon,
                coordinates: JSON.parse(kematian_2018.polygon),
            }
        }));
        ...
        info.update = function (props) {
            this._div.innerHTML = '<h4>Data Kematian Kota Bogor 2018</h4>' +  (props ?
