...
<body>
    ...
    <script>
        ...
        const kotabogorData = kotabogor.map(kematian_2019 =>({
            type: "Feature",
            properties: {
                name: kematian_2019.name,
                id: kematian_2019.id,
                alt_name: kematian_2019.alt_name,
                population: kematian_2019.population,
                luas_wilayah: kematian_2019.luas_wilayah,
                kematian: kematian_2019.kematian,
                latitude: kematian_2019.latitude,
                longitude: kematian_2019.longitude
            },
            geometry: {
                type: kematian_2019.type_polygon,
                coordinates: JSON.parse(kematian_2019.polygon),
            }
        }));
        ...
        info.update = function (props) {
            this._div.innerHTML = '<h4>Data Kematian Kota Bogor 2019</h4>' +  (props ?
