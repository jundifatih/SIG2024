...
<body>
    ...
    <script>
        ...
        const kotabogor = @json($kotabogor);

        const kotabogorData = kotabogor.map(kota_bogor =>({
            type: "Feature",
            properties: {
                name: kota_bogor.name,
                id: kota_bogor.id,
                alt_name: kota_bogor.alt_name,
                population: kota_bogor.population,
                luas_wilayah: kota_bogor.luas_wilayah,
                kematian: kota_bogor.kematian,
                latitude: kota_bogor.latitude,
                longitude: kota_bogor.longitude
            },
            geometry: {
                type: kota_bogor.type_polygon,
                coordinates: JSON.parse(kota_bogor.polygon),
            }
        }));
        ...
        info.update = function (props) {
            this._div.innerHTML = '<h4>Data Kematian Kota Bogor</h4>' +  (props ?
                '<b>' + props.name + '</b><br />' + 'Meninggal: '+props.kematian.toLocaleString('id-ID') + ' Jiwa [Data 2020]'
                + '</b><br />' + 'Populasi: ' + props.population.toLocaleString('id-ID') + ' Jiwa [Data 2020]'
