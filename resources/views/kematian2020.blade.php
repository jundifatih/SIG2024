...
<body>
    ...
    <script>
        ...
        const kotabogorData = kotabogor.map(kematian_2020 =>({
            type: "Feature",
            properties: {
                name: kematian_2020.name,
                id: kematian_2020.id,
                alt_name: kematian_2020.alt_name,
                population: kematian_2020.population,
                luas_wilayah: kematian_2020.luas_wilayah,
                kematian: kematian_2020.kematian,
                latitude: kematian_2020.latitude,
                longitude: kematian_2020.longitude
            },
            geometry: {
                type: kematian_2020.type_polygon,
                coordinates: JSON.parse(kematian_2020.polygon),
            }
        }));
        ...
        info.update = function (props) {
            this._div.innerHTML = '<h4>Data Kematian Kota Bogor 2020</h4>' +  (props ?
