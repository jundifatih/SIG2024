...
<body>
    ...
    <script>
        ...
        const kotabogorData = kotabogor.map(kematian_2017 =>({
            type: "Feature",
            properties: {
                name: kematian_2017.name,
                id: kematian_2017.id,
                alt_name: kematian_2017.alt_name,
                population: kematian_2017.population,
                luas_wilayah: kematian_2017.luas_wilayah,
                kematian: kematian_2017.kematian,
                latitude: kematian_2017.latitude,
                longitude: kematian_2017.longitude
            },
            geometry: {
                type: kematian_2017.type_polygon,
                coordinates: JSON.parse(kematian_2017.polygon),
            }
        }));
        ...
        info.update = function (props) {
            this._div.innerHTML = '<h4>Data Kematian Kota Bogor 2017</h4>' +  (props ?
